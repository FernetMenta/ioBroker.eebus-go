...
/**
 * Class for configuring LPP Energy Guards (add/remove EEBUS and Manual production guards)
 */
class LppEnergyGuardsConfig extends Component {
    /**
    ...
    constructor(props) {
        ...
        this.state = {
            lppEnergyGuards: props.native.lppEnergyGuards || [],
            discoveredDevices: {},
    ...
    /**
     * Get LPP energy guards as array for DataGrid rows.
     *
     * @returns {Array} rows
     */
    getGuardRows() {
        const guards = this.props.native.lppEnergyGuards || [];
    ...
    handleAddManual = () => {
        ...
        this.props.onChange('lppEnergyGuards', guards);
    };
        ...
        return (
            <form style={{ ...styles.tab }}>
                <div style={{ ...styles.column, ...styles.columnSettings }}>
                    <h3>{I18n.t('LPP Energy Guards')}</h3>
...
LppEnergyGuardsConfig.propTypes = {
...
export default LppEnergyGuardsConfig;
