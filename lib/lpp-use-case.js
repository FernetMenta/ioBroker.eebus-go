...
class LppUseCase {
    ...
    async #distributeLimit(isActive) {
        ...
        // Use the stored production limit value (set by #handleDataUpdateLimit)
        ...
        for (let i = 0; i < this.#guards.length; i++) {
            ...
            try {
                if (limitInfo.skip) {
                    ...
                    // Connected EEBUS guard: use pre-calculated effective limit
                    ...
                    // Manual guard: use pre-calculated effective limit
     ...
     * capped at the contractual production nominal max.
