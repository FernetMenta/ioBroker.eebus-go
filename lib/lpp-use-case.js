...
class LppUseCase {
    ...
    async #handleDataUpdateLimit() {
        ...
        if (limit.is_active) {
            ...
            await this.#onLimitUpdate(true, limitValue, durationNs);
        } else {
            ...
            await this.#onLimitUpdate(false, 0, 0);
        }
    }
    ...
    async #handleDataUpdateHeartbeat() {
        ...
        log.debug(`LPP heartbeat update: withinDuration=${res.is_within_duration}`);
