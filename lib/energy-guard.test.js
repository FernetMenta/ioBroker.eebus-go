...
describe('BaseEnergyGuard (via EebusEnergyGuard)', () => {
    ...
    beforeEach(() => {
        ...
        guard = new EebusEnergyGuard(adapter, 'TestGuard', 'abc123def456');
    });
...
describe('EebusEnergyGuard', () => {
    ...
    beforeEach(() => {
        adapter = createMockAdapter();
        guard = new EebusEnergyGuard(adapter, 'WallBox', 'ski123456789012345678901234567890abcdef01');
    });
...
describe('ManualEnergyGuard', () => {
    ...
    beforeEach(() => {
        adapter = createMockAdapter();
        guard = new ManualEnergyGuard(adapter, 'HeatPump');
    });
