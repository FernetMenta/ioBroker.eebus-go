 ...
 * @returns {Promise<string>} The instance_id from the response
 */
 ...
 *
 * @param {object} controlClient - gRPC control client
 * @param {string} instanceId - Instance ID returned by AddUseCase
 * @param {(event: object) => void} onEvent - Callback invoked for each event
 * @returns {object} gRPC readable stream
 */
function subscribeCsLpcEvents(controlClient, instanceId, onEvent) {
